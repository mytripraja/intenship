    ...
    <>
      ...
      <div className="main-container">
        <div className="card">
          ...
          {/* Step 1: Phone Number */}
          {step === 1 && (
            <form onSubmit={requestOTP} style={{ animation: "slideLeft 0.4s ease" }}>
          ...
          {/* Step 2: OTP */}
          {step === 2 && (
            <form onSubmit={verifyOTP} style={{ animation: "slideRight 0.4s ease" }}>
              <div className="input-group">
                ...
                <p className="phone-display">
                  Code sent to <span className="phone-number">+91 {phone}</span>
                </p>
              </div>
          ...
          {step === 3 && (
            <div className="success-view">
              ...
              <p className="phone-display" style={{ marginTop: "16px" }}>
                Welcome to the <span className="phone-number">Internship Portal</span>
              </p>
            </div>
          )}
